...
[rewrite_local]
^https:\/\/glados\.network\/console\/account$ url script-request-header https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js
^https:\/\/railgun\.info\/console\/account$ url script-request-header https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js
^https:\/\/glados\.vip\/console\/account$ url script-request-header https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js

[task_local]
10 7 * * * https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js, tag=GLaDOS 签到, enabled=true
...
Loon:
[Script]
http-request ^https://glados\.network/console/account$ script-path=https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js, requires-body=false, tag=GLaDOS 抓包
http-request ^https://railgun\.info/console/account$ script-path= https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js, requires-body=false, tag=GLaDOS 抓包
http-request ^https://glados\.vip/console/account$ script-path= https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js, requires-body=false, tag=GLaDOS 抓包
cron "10 7 * * *" script-path= https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js, tag=GLaDOS 签到, enabled=true
...
Surge:
[Script]
GLaDOS 抓包 = type=http-request, pattern=^https://glados\.network/console/account$, requires-body=0, script-path= https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js
GLaDOS 抓包2 = type=http-request, pattern=^https://railgun\.info/console/account$, requires-body=0, script-path= https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js
GLaDOS 抓包3 = type=http-request, pattern=^https://glados\.vip/console/account$, requires-body=0, script-path= https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js
GLaDOS 签到 = type=cron, cronexp="10 7 * * *", script-path= https://raw.githubusercontent.com/Phdxmy336/js/main/glados.js, timeout=60
